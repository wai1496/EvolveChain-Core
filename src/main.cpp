...
// Copyright (c) 2009-2014 The EvolveChainX developers
...
#if defined(NDEBUG)
# error "EvolveChainX cannot be compiled without assertions."
#endif
...
bool fTxIndex = false;
/* Identified information which is used by init, sendcoins */
bool walletIdentified = false;
bool walletKYC = false;
bool addressIdentified = false;
std::string identiKYC = "";
std::string ExternalIPAddress = "";
std::string identiCode = "";
std::string identiEmail = "";
std::string identiPhone = "";
...
const string strMessageMagic = "EvolveChainX Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("evolvechain-scriptch");
            ...
            if (!ConnectTip(state, pindexConnect)) {
                if (state.IsInvalid()) {
                    ...
                    if (!state.CorruptionPossible())
						...
						LogPrintf("Corruption Possible Tip:: %s\n",chainMostWork.Tip());
                    fComplete = false;
