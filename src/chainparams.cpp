...
unsigned int pnSeed[] =
{
    ...
    0xc15ebb6a, 0x2c08c452, 0xc7fd0652, 0x7604f8ce, 0xffb36788, 0xa4c2efd5, 0xe9614018, 0xab49e557,
...
public:
    CMainParams() {
		...
		vAlertPubKey = ParseHex("04a255cc5a92589fe56e0cf5e4c2c4163f9e4a0f433f6f2ab5b44b3257236cf89d2abe44727a3e271c21520071554d5eae6e4b1bb8d1e66a0c54d561d31f2d7b16");
        nDefaultPort = 6789;
        nRPCPort = 6788;
        ...
        //   vMerkleTree: 4a5e1e
        const char* pszTimestamp = "The New Times 03/Jan/2018 EvolveChain launches crypto KYC block chain.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 0x618aa15b << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue  = 1;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0466d1bf14fdd99d1b3032bf81b7a57fd83d8daebf4023fddb3ff4c10b6b7b51295408dbed56e789bd041238668780e3bb385f735c36cbca6589b0ffc8660c741b") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1513336283;
...
//        assert(genesis.hashMerkleRoot == uint256("0x4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));
        ...
        vSeeds.push_back(CDNSSeedData("evolvechainx.com", "evolvechainx.com"));
								vSeeds.push_back(CDNSSeedData("evolvechain.org", "seed.evolvechain.org"));								
//        vSeeds.push_back(CDNSSeedData("bluematt.me", "dnsseed.bluematt.me"));
//        vSeeds.push_back(CDNSSeedData("dashjr.org", "dnsseed.evolvechain.dashjr.org"));
//        vSeeds.push_back(CDNSSeedData("evolvechainstats.com", "seed.evolvechainstats.com"));
...
public:
    CTestNetParams() {
        ...
        vAlertPubKey = ParseHex("0466d1bf14fdd99d1b3032bf81b7a57fd83d8daebf4023fddb3ff4c10b6b7b51295408dbed56e789bd041238668780e3bb385f735c36cbca6589b0ffc8660c741b");
        nDefaultPort = 16789;
        nRPCPort = 16788;
        strDataDir = "testnet3";
...
//        vSeeds.push_back(CDNSSeedData("bluematt.me", "testnet-seed.bluematt.me"));
        ...
        base58Prefixes[PUBKEY_ADDRESS] = list_of(131);
        base58Prefixes[SCRIPT_ADDRESS] = list_of(106);
        base58Prefixes[SECRET_KEY]     = list_of(339);
        base58Prefixes[EXT_PUBLIC_KEY] = list_of(0x14)(0x25)(0x17)(0xBF);
        base58Prefixes[EXT_SECRET_KEY] = list_of(0xA4)(0x15)(0x8A)(0xA4);
    }
