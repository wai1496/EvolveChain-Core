...
#ifndef _EVOLVECHAINRPC_PROTOCOL_H_
#define _EVOLVECHAINRPC_PROTOCOL_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // EvolveChain is not connected
