...
bool IsCanonicalSignature(const valtype &vchSig, unsigned int flags) {
    ...
    // See https://evolvechaintalk.org/index.php?topic=8392.msg127623#msg127623
...
bool Solver(const CScript& scriptPubKey, txnouttype& typeRet, vector<vector<unsigned char> >& vSolutionsRet)
{
    ...
    if (mTemplates.empty())
    {
        ...
        // EvolveChain address tx, sender provides hash of pubkey, receiver provides signature and pubkey
