...
#ifndef H_EVOLVECHAIN_SCRIPT
#define H_EVOLVECHAIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CEvolveChainAddress
 */
...
public:
    ...
    // Pre-version-0.6, EvolveChain always counted CHECKMULTISIGs
