...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/evolvechain"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("EvolveChain"),
     ...
     * override -datadir in the evolvechain.conf file in the default data directory
     * (to be consistent with evolvechaind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
