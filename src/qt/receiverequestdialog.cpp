...
#include "evolvechain-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatEvolveChainURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + EvolveChainUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatEvolveChainURI(info));
}
