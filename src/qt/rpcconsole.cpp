    ...
    historyPtr(0)
{
	...
	ui->openIdentificationLogfileButton->setIcon(QIcon(":/icons/export"));
#endif
...
void RPCConsole::setClientModel(ClientModel *model)
{
    ...
    if(model)
    {
		...
		ui->labelEmailValue->setText(QString::fromUtf8(identiEmail.c_str()));
		ui->labelPhoneValue->setText(QString::fromUtf8(identiPhone.c_str()));
		ui->labelKYCValue->setText(QString::fromUtf8(identiKYC.c_str()));
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the EvolveChain RPC console.") + "<br>" +
...
void RPCConsole::on_openIdentificationLogfileButton_clicked()
{
    GUIUtil::openIdentificationLogfile();
}
