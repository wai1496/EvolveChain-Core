// Copyright (c) 2011-2014 The EvolveChainX Core developers
...
BOOST_AUTO_TEST_CASE(base58_keys_valid_parse)
{
    ...
    BOOST_FOREACH(Value& tv, tests)
    {
        ...
        if(isPrivkey)
        {
            ...
            // Note: CEvolveChainSecret::SetString tests isValid, whereas CEvolveChainAddress does not!
