...
{
    BOOST_CHECK(TestSplitHost("www.evolvechainx.com", "www.evolvechainx.com", -1));
    BOOST_CHECK(TestSplitHost("[www.evolvechainx.com]", "www.evolvechainx.com", -1));
    BOOST_CHECK(TestSplitHost("www.evolvechainx.com:80", "www.evolvechainx.com", 80));
    BOOST_CHECK(TestSplitHost("[www.evolvechainx.com]:80", "www.evolvechainx.com", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:9878", "127.0.0.1", 9878));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:9878", "127.0.0.1", 9878));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:9878", "::ffff:127.0.0.1", 9878));
    BOOST_CHECK(TestSplitHost("[::]:9878", "::", 9878));
    BOOST_CHECK(TestSplitHost("::9878", "::9878", -1));
    BOOST_CHECK(TestSplitHost(":9878", "", 9878));
    BOOST_CHECK(TestSplitHost("[]:9878", "", 9878));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:9878", "127.0.0.1:9878"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:9878", "[::]:9878"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
