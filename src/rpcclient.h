...
#ifndef _EVOLVECHAINRPC_CLIENT_H_
#define _EVOLVECHAINRPC_CLIENT_H_ 1
...
/** Show help message for evolvechain-cli.
 ...
 *
 * @note the argument can be removed once evolvechain-cli functionality is removed from evolvechaind
 */
