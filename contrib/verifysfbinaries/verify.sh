...
WORKINGDIR="/tmp/evolvechain"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/evolvechain/EvolveChain/evolvechain-0.9.0rc1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/evolvechain/EvolveChain/"
VERSIONPREFIX="evolvechain-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'evolvechain-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[evolvechain-]<version>-[rc[0-9]] (example: evolvechain-0.7.1-rc1)"
   echo "wget output:"
