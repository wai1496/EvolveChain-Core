...
unlocked to sign the EvolveChain-Qt.app bundle.
...
allowing somebody to distribute a EvolveChain-Qt.app or evolvechain-qt-setup.exe with a valid
...
that the evolvechain-qt.exe file inside the installer had not been tampered with.
