...
EVOLVECHAIND=${1}/evolvechaind
CLI=${1}/evolvechain-cli
...
B4ARGS="-datadir=$D4"
$EVOLVECHAIND $EVOLVECHAINDARGS $B4ARGS &
B4PID=$!
...
B3ARGS="-datadir=$D3"
$EVOLVECHAIND $EVOLVECHAINDARGS $B3ARGS &
B3PID=$!
...
function StartThree {
  $EVOLVECHAIND $EVOLVECHAINDARGS $B1ARGS &
  B1PID=$!
  $EVOLVECHAIND $EVOLVECHAINDARGS $B2ARGS &
  B2PID=$!
  $EVOLVECHAIND $EVOLVECHAINDARGS $B3ARGS &
  B3PID=$!
}
