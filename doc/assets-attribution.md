The following is a list of assets used in the evolvechain source and their proper attribution.
...
* License: MIT
* Site: [https://evolvechaintalk.org/index.php?topic=15276.0](https://evolvechaintalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original evolvechain logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/evolvechain.icns, src/qt/res/src/evolvechain.svg,
	src/qt/res/src/evolvechain.ico, src/qt/res/src/evolvechain.png,
	src/qt/res/src/evolvechain_testnet.png, docs/evolvechain_logo_doxygen.png,
