EvolveChain version 0.5.4 is now available for download at:
http://sourceforge.net/projects/evolvechain/files/EvolveChain/evolvechain-0.5.4/
...
http://gitorious.org/evolvechain/evolvechaind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix EvolveChain-Qt notifications under Growl 1.3.
Increase required age of EvolveChain-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxEvolveChain properly when installing EvolveChain-Qt over it. (Windows)
