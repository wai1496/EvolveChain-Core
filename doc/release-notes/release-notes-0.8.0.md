EvolveChain-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/evolvechain/files/EvolveChain/evolvechain-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the EvolveChain
...
New/changed settings (command-line or evolvechain.conf file)
--------------------------------------------------------
