Download URL: https://sourceforge.net/projects/evolvechain/files/EvolveChain/evolvechain-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 EVC fee schedule (users still pay 0.01 EVC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #evolvechain00 - #evolvechain99
